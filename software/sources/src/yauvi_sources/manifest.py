...
WORKSPACE_MANIFEST_PATHS: Mapping[str, str] = {
    ...
    "actstate": "software/activity-state/src/actstate/sources.yaml",
    "activity_state": "software/activity-state/src/actstate/sources.yaml",
    "structqc": "software/structqc/src/structqc/sources.yaml",
    "structure_quality": "software/structqc/src/structqc/sources.yaml",
    "assembly_context": "software/assembly-context/src/assembly_context/sources.yaml",
    "assembly-context": "software/assembly-context/src/assembly_context/sources.yaml",
    "site_context": "software/site-context/src/site_context/sources.yaml",
    "site-context": "software/site-context/src/site_context/sources.yaml",
